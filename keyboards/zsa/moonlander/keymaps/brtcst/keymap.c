...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUMPAD] = LAYOUT_moonlander( // Numpad layer
    // Left Hand                                                                       // Right Hand
    DT_UP,      DT_DOWN,    DT_PRNT,            XXXXXXX,            ,        XXXXXXX,    XXXXXXX,              LGUI(LALT(BP_B)), XXXXXXX, XXXXXXX    ,     XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
    XXXXXXX,    XXXXXXX,    KC_MPRV,        TD(D_PLAY_STOP),        KC_MNXT,        KC_MUTE, XXXXXXX,                 XXXXXXX, KC_NUM, KC_KP_7, KC_KP_8, KC_KP_9, BP_EQL, BP_PERC,
    _______,    KC_RALT,    KC_LALT,         KC_LCTL,     KC_LSFT, KC_VOLU,  XXXXXXX,                 XXXXXXX, KC_PPLS, KC_KP_4,KC_KP_5, KC_KP_6, KC_PAST, XXXXXXX,
  ...
  [FXARROWS] = LAYOUT_moonlander( // Arrows layer
    ...
    DM_RSTP,    TD(D_F9_F21),   TD(D_F10_F22),  TD(D_F11_F23),  TD(D_F12_F24), LCTL(BP_V),                                   XXXXXXX,    KC_END,     XXXXXXX,    KC_PGDN,    XXXXXXX,    _______,
