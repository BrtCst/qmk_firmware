...
#define TAP_DANCE_LIST {\
        ...
        [D_F6_F18] = CUSTOM_ACTION_TAP_DANCE_KEYCODES_ADVANCED(KC_F6, KC_RALT, KC_F18, KC_RALT),\
        [D_F7_F19] = CUSTOM_ACTION_TAP_DANCE_KEYCODES_ADVANCED(KC_F7, KC_LALT, KC_F19, KC_LALT),\
        [D_F8_F20] = CUSTOM_ACTION_TAP_DANCE_KEYCODES_ADVANCED(KC_F8, KC_LCTL, KC_F20, KC_LCTL),\
