...
#define BP_Q_MOD MT(MOD_LALT, BP_Q)
#define BP_G_MOD MT(MOD_RCTL, BP_G)
#define BP_H_MOD MT(MOD_RSFT, BP_H)
#define BP_F_MOD MT(MOD_RALT, BP_F)
...
static const uint16_t base_top_row[14]        = {BP_W,            BP_B,            BP_EACU,         BP_P,            BP_O,            BP_EGRV,         QK_LEAD,         /*********/ TD(D_2),         BP_DCIR,         BP_V,            BP_D,            BP_L,            BP_J,            BP_Z};
static const uint16_t base_mid_row[14]        = {CMC_SLASH,       BP_A_MOD,        BP_U_MOD,        BP_I_MOD,        BP_E_MOD,        BP_COMM,         TD(D_ESC_LOCK),  /*********/ TD(D_3),         BP_C,            BP_T_MOD,        BP_S_MOD,        BP_R_MOD,        BP_N_MOD,        BP_M};
static const uint16_t base_bot_row[14]        = {KC_LGUI,         BP_AGRV_MOD,     BP_Y_MOD,        BP_X_MOD,        BP_DOT_MOD,      BP_K,                             /*********/                  BP_QUOT,         BP_Q_MOD,        BP_G_MOD,        BP_H_MOD,        BP_F_MOD,        BP_CCED};
static const uint16_t base_thumb_row[6]       = {SH_MON,          LT(FN,KC_TAB),   LT(NAV, KC_SPC), /*********/      LT(NUM, KC_BSPC),KC_DEL,          KC_ENTER};
...
static const uint16_t gaming_thumb_row[6] = {_______, _______, KC_SPC,    _______, _______, _______};
...
static const uint16_t num_bot_row[14] = {XXXXXXX,         KC_RALT,         KC_LSFT,         LCTL_T(BP_COMM), LALT_T(BP_DOT),  XXXXXXX,                          /*********/                  XXXXXXX,         CMC_KC_1,     CMC_KC_2,     CMC_KC_3,        BP_DOT,           XXXXXXX};
...
static const uint16_t lock_thumb_row[6]   = {XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, XXXXXXX};
