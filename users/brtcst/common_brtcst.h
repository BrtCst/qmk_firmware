...
static const uint16_t mid_row[14] = {BP_SLSH, BP_A_MOD, BP_U_MOD, BP_I_MOD, LSFT_T(KC_F), BP_COMM, TD(D_ESC_LOCK), TD(D_3), BP_C, BP_T_MOD, BP_S_MOD, BP_R_MOD, BP_N_MOD, BP_M};
